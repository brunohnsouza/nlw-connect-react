...
export const getPostSubscriptionsUrl = () => {
  ...
  return `https://nlw-connect-api.onrender.com/subscriptions`
}
...
/**
 * @summary Access invite link and redirects user to the subscription page
 */
export const getGetInvitesSubscriberIdUrl = (subscriberId: string,) => {


  return `https://nlw-connect-api.onrender.com/invites/${subscriberId}`
}
...
export const getGetSubscribersSubscriberIdRankingClicksUrl = (subscriberId: string,) => {
  ...
  return `https://nlw-connect-api.onrender.com/subscribers/${subscriberId}/ranking/clicks`
}
...
export const getGetSubscribersSubscriberIdRankingCountUrl = (subscriberId: string,) => {
  ...
  return `https://nlw-connect-api.onrender.com/subscribers/${subscriberId}/ranking/count`
}
...
export const getGetSubscribersSubscriberIdRankingPositionUrl = (subscriberId: string,) => {
  ...
  return `https://nlw-connect-api.onrender.com/subscribers/${subscriberId}/ranking/position`
}
...
export const getGetRankingUrl = () => {
  ...
  return `https://nlw-connect-api.onrender.com/ranking`
}
